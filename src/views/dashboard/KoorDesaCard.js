...
//       if (slsError) {
//         console.error('Error fetching SLS data:', slsError);
//       }
...
//       if (keluargaError) {
//         console.error('Error fetching Keluarga data:', keluargaError);
//       }
...
//       if (pendudukError) {
//         console.error('Error fetching Penduduk data:', pendudukError);
//       }
...
//       // Update stats
//       setStats({
//         sls: slsData.length || 0,
//         keluarga: keluargaData.length || 0,
//         penduduk: pendudukData.length || 0,
//       });
